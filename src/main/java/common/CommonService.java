...
public class CommonService {
   ...
   private void htmlSend(String name, String email, HttpSession session) {
      ...
      mail.setAuthentication("sugod1", "alskdj456");
      mail.setSSLOnConnect(true);   // 로그인 버튼 누르기
      
      try {
         mail.setFrom("sugod1@naver.com", "소소한 스토리지 관리자");
         mail.addTo(email, name);
         
         mail.setSubject("소소한 스토리지 가입 축하메일!");
         
         StringBuffer msg = new StringBuffer("<html>");
         msg.append("<body>");
         msg.append("<a href='naver.com'><img src='https://www.jungle.co.kr/image/ea06cd0346fa8777cb624e3f'/></a>");
         msg.append("<hr>");
         msg.append("<h3>저희 소소한 스토리지</h3>");
         msg.append("<p>가입을 축하합니다.</p>");
         msg.append("<p>바로 <br> 이용가능합니다</p>");
   ...
   private void attachSend(String name, String email, HttpSession session) {
      ...
      try {
         mail.setFrom("cla7901@naver.com", "소소한 스토리지 관리자");
         mail.addTo(email, name);
   ...
   private void simpleSend(String name, String email) {
      ...
      try {
         mail.setFrom("cla7901@naver.com", "소소한 스토리지 관리자");   // 보내는 사람 지정
